...
//年选择下拉框
var s_tiannet_select = "width:64px;display:none;height:18px;font-size:12px;";
//月、时、分选择下拉框
var s_tiannet_select2 = "width:40px;display:none;height:18px;font-size:12px;";
//日期选择控件体的样式
...
document.write('<input style="color: black;" type="button" style="'+s_tiannet_turn+'" value="年↑" title="上一年" onClick="tiannetPrevYear();">');
document.write('<input style="color: black;" type="button" style="'+s_tiannet_turn+'" value="年↓" title="下一年" onClick="tiannetNextYear();">&nbsp;');
document.write('<input style="color: black;" type="button" style="'+s_tiannet_turn+'" value="月↑" title="上一月" onClick="tiannetPrevMonth();">');
document.write('<input style="color: black;" type="button" style="'+s_tiannet_turn+'" value="月↓" title="下一月" onClick="tiannetNextMonth();">');
document.write('</div>');
//输出一条横线
document.write('<div style="'+s_tiannet_line+'"></div>');
...
tiannetOutObject.fireEvent('onchange');
return;
}
var mm = tiannetMonth;
var day = tiannetDay;
...
function tiannetPopCalendar(){
	...
	iX = findOffsetLeft(tiannetOutObject);
	iY = findOffsetTop(tiannetOutObject)+tiannetOutObject.offsetHeight;
...
//按ESC键关闭该控件
function dt_onDocumentkeypress(){
	if( window.event.keyCode == 27 ){
		tiannetHideControl();
	}
}

document.onclick=dt_onDocmentclick;
document.onkeypress=dt_onDocumentkeypress;
