	...
	<tr>
		<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30"><a href="index.jsp">首页</a>&nbsp;&gt;&nbsp;<a href="PPMproject.do?method=list&refproject=list">项目</a>&nbsp;&gt;&nbsp;<a href="PPMMember.do?method=list&projectId=<%=ppmmember.getProjectID()%>">项目成员</a>&nbsp;&gt;&nbsp;编辑项目成员 </td>
				</tr>
			</table>
			<form id="frmDocAdd" name="frmDocAdd" action="PPMMember.do?method=update" method="post">
				<table width="900" border="0" cellpadding="2" cellspacing="2" class="blockborder">
					<tr>
						<td height="20" class="tableBackGround" colspan="2">&nbsp;<span class="blocktitle">编辑项目成员</span></td>
				  	</tr>
			  		<tr>
			  			<td>
			  						...
			  						<td rowspan="2" valign="top">
			  							...
			  							<table>
			  								<tr>
												...
												<input type="hidden" name="memberId" id="memberId" value="<%=ppmmember.getMemberID()%>" />
												<td height="20" colspan="3" ><input id="userName" type="text" value="<%=ppmmember.getUserName()%>"  name="userName" style="width: 300px;height: 15px;" onblur="javaScript:ongoFormOk('userName','checkName');" >&nbsp;<span style="color: red" >*</span>&nbsp;<img src="images/choose.gif" style="cursor: hand;" onclick="javaScript:showDialog('PPMMember.do?method=choseUser','620','290');" >
												<span id="checkName" style="display: none;visibility:hidden;" ><font color="red">姓名不能为空</font></span>
												</td>
										  	</tr>
										  	<tr>
												<td height="20" align="center">所属单位</td>
												<td height="20"><input id="unit" type="text" name="unit" style="width: 300px;height: 15px;" value="<%=ppmmember.getUnit()%>"  onblur="javaScript:ongoFormOk('unit','checkUnit');" >&nbsp;<span style="color: red" >*</span>
											...
											<tr>	
												...
												<td height="20"><input id="position" type="text" name="position" style="width: 300px;height: 15px;" value="<%=ppmmember.getPosition()%>" onblur="javaScript:ongoFormOk('position','checkPosition');" >&nbsp;<span style="color: red" >*</span>
                                            ...
                                            <tr>
										  	...
										  	<tr>
												...
												<td height="20"><input id="tel" type="text" name="tel" style="width: 300px;height: 15px;" value="<%=ppmmember.getTel()%>"  maxlength="11" onkeyup="value=value.replace(/[^\d\-]/g,'');" onblur="javaScript:ongoFormOk('tel','checkTel');" >
											...
											<tr>
												...
												<td height="20"><input id="email" type="text" name="email" style="width: 300px;height: 15px;" value="<%=ppmmember.getEMail()%>" onblur="javaScript:ongoFormOk('email','checkEmail');" >
												<span style="color: red" >*</span>
										  	...
										  	<tr>
												...
												<td height="20"><textarea id="notes" name="notes" style="width: 350px;height: 150px;" ><%=ppmmember.getNotes()%></textarea>
										  	</tr>
...
<script type="text/javascript">
<!--
var custRole = document.getElementById("custRole");
var ufidaRole = document.getElementById("ufidaRole");
var opsufida = ufidaRole.options;
var ops = custRole.options;
for(i = 0; i<ops.length;i++){  
   if(ops[i].value == '<%=ppmmember.getCustRole()%>'){
      ops[i].selected  = true;
      break;
   }
} 
for(i=0;i<opsufida.length;i++){
  if(opsufida[i].value == '<%=ppmmember.getUfidaRole()%>'){
      opsufida[i].selected  = true;
      break;
   }
 }
//-->
